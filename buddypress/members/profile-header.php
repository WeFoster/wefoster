...
<?php do_action('open_bp_profile_sidebar'); ?>
   ...
   <?php /* Show Quick Menu for own Profile page */ if ( bp_is_my_profile() ) : ?>
                ...
                <div id="profile-quick-menu">
                    ...
                    <select name="forma" multiple title="<?php _e('Quick Links', 'wefoster'); ?>" onchange="location = this.options[this.selectedIndex].value;">
                    ...
                    <optgroup label="<?php _e('Quick Links', 'wefoster'); ?>">
                      ...
                      <option value="<?php echo $userLink; ?>settings/profile/"><?php _e('Profile Visibility', 'wefoster'); ?></option>
                    </optgroup>
                    <optgroup label="<?php _e('Settings', 'wefoster'); ?>">
                        ...
                        <option value="<?php echo $userLink; ?>settings/notifications/"><?php _e('Notification Settings', 'wefoster'); ?> </option>
