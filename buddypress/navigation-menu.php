	...
	<ul id="bp-user-navigation" class="nav navbar-nav <?php do_action( 'wf_class_bp_menu' ); ?>">
		...
		<?php if ( is_user_logged_in() ): ?>
			...
			<li id="bp-profile-menu" class="dropdown menu-groups">
				...
				<a href="<?php echo bp_get_loggedin_user_link(); ?>" data-target="#" data-toggle="dropdown"
				   class="dropdown-toggle"><?php echo bp_loggedin_user_avatar( 'type=thumb&width=70&height=70' ); ?>
