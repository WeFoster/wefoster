+function(a) {
    ...
    var f = [], g = !!window.createPopup, h = !1, i = !1;
    a.SmartMenus = function(b, c) {
        this.$root = a(b), this.opts = c, this.rootId = "", this.$subArrow = null, this.subMenus = [], 
        this.activatedItems = [], this.visibleSubMenus = [], this.showTimeout = 0, this.hideTimeout = 0, 
        this.scrollTimeout = 0, this.clickActivated = !1, this.zIndexInc = 0, this.$firstLink = null, 
        this.$firstSub = null, this.disabled = !1, this.$disableOverlay = null, this.isTouchScrolling = !1, 
        this.init();
        ...
        prototype: {
            init: function(c) {
                ...
                if (!c) {
                    ...
                    g += this.rootId, this.opts.hideOnClick && a(document).bind(e([ [ "touchstart", a.proxy(this.docTouchStart, this) ], [ "touchmove", a.proxy(this.docTouchMove, this) ], [ "touchend", a.proxy(this.docTouchEnd, this) ], [ "click", a.proxy(this.docClick, this) ] ], g)), 
            ...
            itemActivate: function(b) {
                ...
                if (this.visibleSubMenus.length > e && this.menuHideSubMenus(this.activatedItems[e - 1] && this.activatedItems[e - 1][0] == b[0] ? e : e - 1), 
            ...
            itemClick: function(b) {
                ...
                if (this.handleItemEvents(c)) {
                    ...
                    if (this.isTouchMode()) {
                        if (c.dataSM("href") && c.attr("href", c.dataSM("href")).removeDataSM("href"), d && (!d.dataSM("shown-before") || !d.is(":visible")) && (this.itemActivate(c), 
                        d.is(":visible"))) return !1;
            ...
            itemFocus: function(b) {
                var c = a(b.currentTarget);
                this.handleItemEvents(c) && (this.isTouchMode() && c.dataSM("mousedown") || this.activatedItems.length && this.activatedItems[this.activatedItems.length - 1][0] == c[0] || this.itemActivate(c), 
            ...
            menuHide: function(a) {
                ...
                a.is(":visible"))) {
                    ...
                    a.dataSM("ie-shim") && a.dataSM("ie-shim").remove(), a.dataSM("scroll") && (this.menuScrollStop(a), 
                    a.css({
                        "touch-action": "",
                        "-ms-touch-action": ""
            ...
            menuPosition: function(b) {
                ...
                f = this.opts.bottomToTopSubMenus ? p - x - k : x), this.opts.keepInViewport && !this.isCollapsible()) {
                    ...
                    v && (z + k > s + u + .49 || s > z) || !v && k > u + .49) {
                        ...
                        }).eq(v && this.opts.bottomToTopSubMenus ? 0 : 1).show(), this.isFixed() && b.css({
                            "touch-action": "none",
            ...
            menuScroll: function(a, b, c) {
                ...
                if (a.add(a.dataSM("ie-shim")).css("margin-top", k), h && (e.up && k > e.downEnd || !e.up && k < e.upEnd) && f.eq(e.up ? 1 : 0).show(), 
            ...
            menuScrollTouch: function(b, d) {
                if (d = d.originalEvent, c(d)) {
                    ...
                    if (this.getClosestMenu(e.target) == b[0]) {
                        ...
                        if (/(start|down)$/i.test(d.type)) this.menuScrollStop(b) ? (d.preventDefault(), 
                        this.isTouchScrolling = !0) : this.isTouchScrolling = !1, this.menuScrollRefreshData(b), 
                        a.extend(f, {
                            touchY: e.pageY,
            ...
            winResize: function(a) {
                if (this.handleEvents()) this.isCollapsible() || "onorientationchange" in window && "orientationchange" != a.type || (this.activatedItems.length && this.activatedItems[this.activatedItems.length - 1][0].blur(), 
    ...
    a(function() {
        a("ul.navbar-nav").each(function() {
            ...
            "show.smapi": function(b, c) {
                var d = a(c), e = d.dataSM("scroll-arrows"), f = a(this).data("smartmenus");
            ...
            "click.smapi": function(b, c) {
                ...
                if (d.isCollapsible()) {
                    var e = a(c), f = e.parent().dataSM("sub");
                    if (f && f.dataSM("shown-before") && f.is(":visible")) return d.itemActivate(e), 
                    d.menuHide(f), !1;
                }
            }
        });
    ...
    !function(a) {
        ...
        e.VERSION = "1.7.7", e.DEFAULTS = {
            ...
            destroy: function() {
                this.$newElement.remove(), this.$bsContainer ? this.$bsContainer.remove() : this.$menu.remove(), 
    ...
    var b = "autogrow", c = b + "-field", d = b + "-mirror";
    a.fn[b] = function(e) {
        return this.each(function(f, g) {
            if ("TEXTAREA" != g.tagName) return !0;
            var h = a(g), i = a("<div></div>");
            i.addClass(d), void 0 !== e && (void 0 !== e.id && i.attr("id", 0 == f ? e.id : e.id + "-" + f), 
            void 0 !== e.classes && i.addClass(e.classes)), h.addClass(c).on("input keyup", function(a) {
                var b = h.val();
                b && "\n" != b.charAt(b.length - 1) || (b += " "), b = b.replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/ /g, "&nbsp;").replace(/\n/g, "<br/>"), 
                i.html(b), h.height(i.height());
            }).off(b + ".resize").on(b + ".resize", function() {
                i.css({
                    border: h.css("border"),
                    "font-family": h.css("font-family"),
                    "font-size": h.css("font-size"),
                    "font-weight": h.css("font-weight"),
                    "letter-spacing": h.css("letter-spacing"),
                    "line-height": h.css("line-height"),
    ...
    var b = {
        common: {
            init: function() {
                function b() {
                    a('iframe:not(.embed-responsive-item)[src*="youtube.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), 
                    a('iframe:not(.embed-responsive-item)[src*="youtube.com"]').addClass("embed-responsive-item"), 
                    a('iframe:not(.embed-responsive-item)[src*="vimeo.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), 
                    a('iframe:not(.embed-responsive-item)[src*="vimeo.com"]').addClass("embed-responsive-item"), 
                    a('iframe:not(.embed-responsive-item)[src*="slideshare.net"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), 
                    a('iframe:not(.embed-responsive-item)[src*="slideshare.net"]').addClass("embed-responsive-item");
                }
                a(".bp-suggestions").autogrow(), a('[data-toggle="tooltip"]').tooltip(), a("#quick-menu-wrap").removeClass("js-flash"), 
                a("#dropdown-filter").removeClass("js-flash"), a("#whats-new-js-wrap").removeClass("js-flash"), 
                a("#whats-new-options").removeClass("js-flash"), a(".navbar-headroom").headroom({
                    tolerance: 5,
                    offset: 50
                }), a("#activity-filter-by,#activity-filter-select").on("change", function() {
                    if ("-1" === this.value || 0 === this.value) a("#activity-filter-notice").removeClass("visible").hide(); else {
                        a("#activity-filter-notice").addClass("visible");
                        var b = a("#activity-filter-by option[value='" + a(this).val() + "']").html();
                        a("#activity-filter-notice span").html(b);
                    }
                }).trigger("change"), a("#reset").click(function() {
                    a("#activity-filter-by").val("-1").trigger("change");
                ...
                jQuery(".create-blog .main submit").addClass("btn btn-lg btn-success"), jQuery(".buddypress.registration .register-section").addClass("col-sm-6"), 
                jQuery(".buddypress.registration .profile-details-section").addClass("col-sm-6"), 
                jQuery(".navbar-inverse .dropdown-menu").addClass("inverse-dropdown"), jQuery("textarea").addClass("form-control"), 
                jQuery(".text-input input[type=text]").addClass("form-control"), jQuery(".dropdown-input select").addClass("selectpicker"), 
                ...
                jQuery("table").addClass("table table-striped"), jQuery("wefoster-bootstrap-select.directory.activity #activity-filter-select select,.wefoster-bootstrap-select .last select, #profile-quick-menu select").selectpicker({
                    ...
                    menuStyle: "dropdown",
                    container: "body"
                }), /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) && a(".directory.activity #activity-filter-select select,#whats-new-post-in, .filter select").selectpicker("mobile"), 
                jQuery("#whats-new").focusin(function() {
                    jQuery("#aw-whats-new-submit").fadeIn();
                }), b(), a(document).ajaxSuccess(function(a) {
                    setTimeout(b, 205);
                }), "undefined" != typeof window.bp && (window.bp.Avatar && bp.Avatar.Attachment.on("change:url", function(a) {
                    console.log(a.attributes);
                }), window.bp.CoverImage && bp.CoverImage.Attachment.on("change:url", function(a) {
                    console.log(a.attributes);
                }));
            }
        },
        wefosterismobile: {
            init: function() {
                a("html").hasClass("touch") && FastClick.attach(document.body), a("#mobile-primary-navigation").removeClass("js-flash"), 
                a("#buddypress-mobile-user-navigation").removeClass("js-flash"), a("#buddypress-mobile-sidebar").removeClass("js-flash"), 
                a("#mobile-primary-navigation-menu-trigger").sidr({
                    name: "mobile-primary-navigation",
                    side: "right",
                    timing: "ease-in-out",
                    speed: 200
                }), a("#close-mobile-primary-navigation").click(function() {
                    a.sidr("close", "mobile-primary-navigation");
                }), a("#buddypress-mobile-user-navigation-trigger").sidr({
                    name: "buddypress-mobile-user-navigation",
                    timing: "ease-in-out",
                    speed: 200
                }), a("#close-buddypress-mobile-user-navigation").click(function() {
                    a.sidr("close", "buddypress-mobile-user-navigation");
                }), a("#buddypress-mobile-sidebar-trigger").sidr({
                    name: "buddypress-mobile-sidebar",
                    timing: "ease-in-out",
                    speed: 200,
                    side: "right"
                }), a("#close-buddypress-mobile-sidebar").click(function() {
                    a.sidr("close", "buddypress-mobile-sidebar");
                }), a(".navigation-trigger, .close-panel-button, #buddypress-mobile-sidebar-trigger").on("click", function() {
                    a(this).toggleClass("closed"), a(".sidr").toggleClass("sidr-active"), a(".sidr").removeClass("sidr-no-transform"), 
                    a(".layout-wrapper").toggleClass("sidr-active-body");
                }), a(window).resize(function() {
                    a.sidr("close", "buddypress-mobile-user-navigation"), a.sidr("close", "mobile-primary-navigation"), 
                    a.sidr("close", "buddypress-mobile-sidebar"), a(".layout-wrapper").removeClass("sidr-active-body"), 
                    a(".sidr").addClass("sidr-no-transform");
                }), a(".bp-sidebar-navigation").smartmenus({
                    subIndicatorsText: '<i class="fa fa-chevron-down"></i>'
                }), a("#buddypress-mobile-sidebar,#buddypress-mobile-user-navigation,#mobile-primary-navigation").perfectScrollbar();
            }
        },
        activity: {
            init: function() {}
