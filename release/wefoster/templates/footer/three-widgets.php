<?php if ( is_active_sidebar( 'footer_widget_one' ) ) : ?>
  <!-- footer widgets -->
    <div class="col-sm-4 <?php do_action('footer_widget_class'); ?>" id="footer-widget-one">
      <?php
...
<?php if ( is_active_sidebar( 'footer_widget_two' ) ) : ?>
  <!-- footer widgets -->
    <div class="col-sm-4<?php do_action('footer_widget_class'); ?>" id="footer-widget-two">
      <?php
...
<?php if ( is_active_sidebar( 'footer_widget_three' ) ) : ?>
  <!-- footer widgets -->
    <div class="col-sm-4<?php do_action('footer_widget_class'); ?>" id="footer-widget-three">
      <?php
